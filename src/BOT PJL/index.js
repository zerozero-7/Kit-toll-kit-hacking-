...
client.on('guildMemberAdd', async member => {
  ...
  const canal = member.guild.channels.cache.get("1258216259120795709")

  const saida = new EmbedBuilder()
    .setAuthor({ name: member.guild.name, iconURL: member.guild.iconURL({ dynamic: true }) })
    .setColor(process.env.PADRAO)
    .setImage("https://cdn.discordapp.com/attachments/1240023617648070747/1260228359888048301/1720498460130.jpg?ex=66b61b9e&is=66b4ca1e&hm=bc90a8f10f2bc28aafab5c9dc15802cb927bc0bafa42ba3f71ee1e27834a93f8&")
